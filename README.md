...
| `stdnum-eu` | Europe: 114 types across AD, AL, AT, AZ, BE, BG, BY, CH, CY, CZ, DE, DK, EE, ES, FI, FO, FR, GB, GR, HR, HU, IE, IS, IT, LI, LT, LU, LV, MC, MD, ME, MK, MT, NL, NO, PL, PT, RO, RS, SE, SI, SK, SM and UA, plus the EU-wide SEPA creditor identifier and One Stop Shop numbers. |
