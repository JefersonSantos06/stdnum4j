...
de pagamento, códigos de produto. **468 tipos de número em 186 países**, sem
nenhuma dependência.
...
Ou os 468 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 134 dos 468 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-apac` | 36 | Ásia-Pacífico e adjacências: AU, CN, HK, ID, IL, IN, JP, KR, MY, NZ, OM, PK, RU, SA, SG, TH, TR, TW, VN. |
...
| `stdnum4j-all` | 468 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
