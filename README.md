...
de pagamento, códigos de produto. **453 tipos de número em 183 países**, sem
nenhuma dependência.
...
Ou os 453 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 128 dos 453 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 25 | América Latina: AR, CL, CO, CR, CU, DO, EC, GT, MX, NI, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 453 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |

O inventário completo, tipo a tipo, está em
**[docs/NUMBERS.md](docs/NUMBERS.md)**. Ele cobre 234 dos 235 tipos de número
que o python-stdnum traz, e acrescenta 219 que ele não tem.
