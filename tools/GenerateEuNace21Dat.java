...
/**
 * NACE Rev. 2.1: the sections, divisions, groups and classes of the European
 ...
 * revision.</p>
 */
public final class GenerateEuNace21Dat implements Source {
    ...
    @Override
    public String title() {
        return "Regenerate eu-nace21.dat, NACE Rev. 2.1";
    }
    ...
    public void generate(Run run, PrintStream out) throws Exception {
        GenerateEuNaceDat.emit(run.file("NACE_R2_1.xml"), "Rev. 2.1", out);
    }
}
