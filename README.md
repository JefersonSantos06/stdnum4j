...
de pagamento, códigos de produto. **461 tipos de número em 185 países**, sem
nenhuma dependência.
...
Ou os 461 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 131 dos 461 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 29 | América Latina: AR, CL, CO, CR, CU, DO, EC, GT, HN, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 461 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
