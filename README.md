...
de pagamento, códigos de produto. **471 tipos de número em 188 países**, sem
nenhuma dependência.
...
Ou os 471 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 135 dos 471 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-apac` | 37 | Ásia-Pacífico e adjacências: AE, AU, CN, HK, ID, IL, IN, JP, KR, MY, NZ, OM, PK, RU, SA, SG, TH, TR, TW, VN. |
| `stdnum4j-africa` | 14 | África: AO, CV, DZ, EG, GH, GN, KE, MA, MU, MZ, SN, TN, ZA. |
...
| `stdnum4j-all` | 471 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
