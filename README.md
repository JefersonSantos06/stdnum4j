...
de pagamento, códigos de produto. **455 tipos de número em 184 países**, sem
nenhuma dependência.
...
Ou os 455 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 128 dos 455 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 26 | América Latina: AR, CL, CO, CR, CU, DO, EC, GT, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 455 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
