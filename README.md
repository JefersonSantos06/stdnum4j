...
de pagamento, códigos de produto. **465 tipos de número em 186 países**, sem
nenhuma dependência.
...
Ou os 465 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 133 dos 465 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 32 | América Latina: AR, BO, CL, CO, CR, CU, DO, EC, GT, HN, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 465 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
