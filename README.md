...
de pagamento, códigos de produto. **458 tipos de número em 184 países**, sem
nenhuma dependência.
...
Ou os 458 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 130 dos 458 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-all` | 458 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
