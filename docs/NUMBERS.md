...
**465 tipos**, em 186 países, mais 30 formatos independentes de país.
...
| [`stdnum4j-latam`](#américa-latina--stdnum4j-latam-32) | 32 | 18 |
...
- **220 tipos daqui não têm equivalente no python-stdnum:** os 178 códigos
...
- [x] `hu.adoazonosito` — Adóazonosító jel — Hungarian personal tax identification number
- [x] `hu.adoszam` — Adószám — Hungarian tax number
...
- [x] `gb.crn` — CRN — Company Registration Number (Companies House)
...
### América Latina — `stdnum4j-latam` (32)
...
- [x] `bo.nit` — NIT — Número de Identificación Tributaria
...
- [x] `sv.nrc` — NRC — Número de Registro de Contribuyente
...
- [x] `gt.cui` — CUI — Código Único de Identificación
- [x] `gt.nit` — NIT — Número de Identificación Tributaria

**Honduras (HN)**

- [x] `hn.rtn` — RTN — Registro Tributario Nacional
...
- [x] `pa.ruc` — RUC — Registro Único de Contribuyentes
...
- [x] `uy.ci` — CI — Cédula de Identidad
