...
de pagamento, códigos de produto. **463 tipos de número em 185 países**, sem
nenhuma dependência.
...
Ou os 463 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 133 dos 463 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 30 | América Latina: AR, CL, CO, CR, CU, DO, EC, GT, HN, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 463 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
