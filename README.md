...
de pagamento, códigos de produto. **462 tipos de número em 185 países**, sem
nenhuma dependência.
...
Ou os 462 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 132 dos 462 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-all` | 462 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
