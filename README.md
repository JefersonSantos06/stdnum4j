...
de pagamento, códigos de produto. **464 tipos de número em 186 países**, sem
nenhuma dependência.
...
Ou os 464 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 133 dos 464 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 31 | América Latina: AR, BO, CL, CO, CR, CU, DO, EC, GT, HN, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 464 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
