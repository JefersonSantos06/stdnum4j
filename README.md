...
de pagamento, códigos de produto. **460 tipos de número em 185 países**, sem
nenhuma dependência.
...
Ou os 460 de uma vez, com o `stdnum4j-all`. Ele não tem código próprio — é a
...
separador. São 130 dos 460 tipos, e para eles o teste de contrato prova que a
...
| `stdnum4j-latam` | 28 | América Latina: AR, CL, CO, CR, CU, DO, EC, GT, HN, MX, NI, PA, PE, PY, SV, UY, VE. |
...
| `stdnum4j-all` | 460 | Agregador: um `pom` que depende de todos os módulos — no Maven, peça-o com `<type>pom</type>`. É também a casa dos testes entre módulos. |
